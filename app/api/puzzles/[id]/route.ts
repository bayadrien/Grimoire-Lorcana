...
const PUZZLES: Record<string, number> = { "ascension-floodborn": 4, "ascension-floodborn-2": 4, "retour-ursula": 9, "givresort": 9, "mer-azurite": 9, "archazia-1": 9, "archazia-2": 9, "jafar-1": 9, "jafar-2": 9, "fabuleux": 9, "contrees-inconnues": 9, "invasion-epineuse": 9 };
